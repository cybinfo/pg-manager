              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="hidden md:flex justify-center">
                  <div className="relative">
                    ...
                    <div className="absolute -top-2 -right-2 h-8 w-8 bg-warning rounded-full flex items-center justify-center text-white text-sm font-bold">
                      ?
                    </div>
                  </div>
                </div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
            <Link href="/register">
              <Card className="h-full hover:shadow-lg transition-shadow cursor-pointer text-center group">
                <CardContent className="pt-6">
                  <div className="h-12 w-12 bg-primary/10 rounded-xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
            ...
            <Link href="/contact">
              <Card className="h-full hover:shadow-lg transition-shadow cursor-pointer text-center group">
                <CardContent className="pt-6">
                  <div className="h-12 w-12 bg-success/10 rounded-xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
            ...
            <Link href="/terms">
              <Card className="h-full hover:shadow-lg transition-shadow cursor-pointer text-center group">
                <CardContent className="pt-6">
                  <div className="h-12 w-12 bg-warning/10 rounded-xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
