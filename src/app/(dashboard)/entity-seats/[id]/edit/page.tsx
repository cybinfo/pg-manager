...
export default function EditEntitySeatPage({
  params,
}: {
  params: Promise<{ id: string }>
}) {
  return (
    <PermissionGuard permission="entity_seats.edit">
      <EditEntitySeatContent params={params} />
    </PermissionGuard>
  )
}

function EditEntitySeatContent({
  params,
}: {
  params: Promise<{ id: string }>
}) {
  ...
  const {
    ...
    table: "entity_seats",
    id,
    select: "*, section:entity_sections(id, name, library:libraries(id, name))",
    initialData: {
      seat_number: "",
      row_number: "",
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <DetailHero
        ...
        backLabel="All Seats"
        icon={Armchair}
        breadcrumbs={[{ label: "Seats", href: "/entity-seats" }, { label: "Edit Seat" }]}
      />
