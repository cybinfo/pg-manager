...
export default function EntitySectionDetailPage() {
  ...
  const { backHref, backLabel } = useBackNavigation({ defaultHref: "/entity-sections", defaultLabel: "All Sections" })
  ...
  if (!section) {
    return <NotFoundState title="Section not found" backHref="/entity-sections" backLabel="All Sections" />
  }
        ...
        actions={
          <div className="flex items-center gap-2 flex-wrap">
            <PermissionGate permission="entity_sections.edit" hide>
              <Link href={`/entity-sections/${section.id}/edit`}>
            ...
            <Link href={`/entity-sections/${section.id}/seats/new`}>
              <Button size="sm">
