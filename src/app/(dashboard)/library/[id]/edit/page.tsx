...
function EditLibraryContent() {
  ...
  const {
    ...
    mapToForm: (record) => {
      ...
      return {
        ...
        has_wifi: (settings.has_wifi as boolean) ?? true,
        has_lockers: (settings.has_lockers as boolean) ?? true,
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <DetailHero
        title="Edit Library"
        subtitle="Update library information"
        backHref={backHref}
        backLabel="All Libraries"
        icon={Library}
        breadcrumbs={[{ label: "Library", href: "/library" }, { label: "Edit Library" }]}
      />
