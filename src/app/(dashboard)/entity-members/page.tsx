...
export default function LibraryMembersPage() {
  return (
    ...
    <ListPageTemplate
      tableKey="entity-members"
      title="Library Members"
      description="Manage member subscriptions and hours"
      icon={Users}
      permission="entity_members.view"
      module="members"
...
exportColumns={exportColumns}
      exportFilename="entity-members"
      createHref="/entity-members/new"
      createLabel="Add Member"
      createPermission="library_members.create"
      headerActions={
        <PermissionGate permission="entity_members.create" hide>
          <Link href="/entity-members/import">
      ...
      detailHref={(member) => `/entity-members/${member.id}`}
