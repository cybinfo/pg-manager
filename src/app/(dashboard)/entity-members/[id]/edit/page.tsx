...
function EditLibraryMemberContent({
  ...
  const { id } = use(params)
  const { backHref } = useBackNavigation({ defaultHref: "/entity-members" })
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <DetailHero
        ...
        icon={Users}
        breadcrumbs={[{ label: "Members", href: "/entity-members" }, { label: "Edit Member" }]}
      />
