...
export default function LibraryLockerDetailPage() {
  ...
  const { backHref, backLabel } = useBackNavigation({ defaultHref: "/entity-lockers", defaultLabel: "All Lockers" })
        ...
        actions={
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <PermissionGate permission="entity_lockers.edit" hide>
              <Link href={`/entity-lockers/${locker.id}/edit`}>
      ...
      <DetailPageTemplate layoutKey="library-locker-detail" entityType="library_locker" record={locker}>
        ...
        {locker.status === "occupied" && locker.current_member && (
          <DetailSection
            ...
            icon={Users}
          >
            <Link href={`/entity-members/${locker.current_member.id}`}>
