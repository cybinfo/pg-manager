...
function EditLibraryLockerContent({
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <DetailHero
        title="Edit Locker"
        subtitle={`#${formData.locker_number} • ${library?.name as string}`}
        backHref={backHref}
        backLabel="All Lockers"
        icon={Lock}
        breadcrumbs={[{ label: "Lockers", href: "/entity-lockers" }, { label: "Edit Locker" }]}
      />

      <form onSubmit={handleSubmit} className="space-y-6">
        <DetailSection title="Locker Details" description="Update locker information and pricing" icon={Lock}>
          {/* Locker Info */}
