...
export default function EditLibraryPaymentPage({
  ...
  return (
    <PermissionGuard permission="entity_payments.edit">
...
function EditLibraryPaymentContent({
  ...
  const { id } = use(params)
  const { backHref } = useBackNavigation({ defaultHref: "/entity-payments" })
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <DetailHero
        ...
        icon={CreditCard}
        breadcrumbs={[{ label: "Library Payments", href: "/entity-payments" }, { label: "Edit Payment" }]}
      />
