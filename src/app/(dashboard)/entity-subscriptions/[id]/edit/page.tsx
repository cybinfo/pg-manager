...
function EditSubscriptionContent({
  ...
  const { id } = use(params)
  const { backHref } = useBackNavigation({ defaultHref: "/entity-subscriptions" })
  ...
  const {
    ...
    redirectTo: `/entity-subscriptions/${id}`,
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <DetailHero
        ...
        icon={CreditCard}
        breadcrumbs={[{ label: "Subscriptions", href: "/entity-subscriptions" }, { label: "Edit Subscription" }]}
      />
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end gap-3">
          <Link href={`/entity-subscriptions/${id}`}>
