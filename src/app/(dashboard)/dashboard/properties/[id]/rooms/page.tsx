  ...
  const columns: Column<Room>[] = [
    {
      ...
      header: "Room",
      render: (room) => (
        <Link href={`/dashboard/rooms/${room.id}`} className="font-medium text-teal-600 hover:underline">
          {room.room_number}
        </Link>
      )
    },
  ...
  if (!property) {
    return (
      <EmptyState
        ...
        action={{ label: "Back to Properties", href: "/dashboard/properties" }}
      />
    )
  }
      ...
      <div className="space-y-6">
        <PageHeader
          ...
          breadcrumbs={[
            ...
            { label: property.name, href: `/dashboard/properties/${propertyId}` },
            { label: "Rooms" }
          ]}
          actions={
            <div className="flex gap-2">
              ...
              <Link href={`/dashboard/rooms/new?property_id=${propertyId}`}>
                <Button size="sm">
        ...
        {rooms.length === 0 ? (
          <EmptyState
            ...
            action={{ label: "Add Room", href: `/dashboard/rooms/new?property_id=${propertyId}` }}
          />
        ) : (
          <DataTable
            data={rooms}
