      ...
      <DetailHero
        ...
        avatar={
          <div className={`p-3 rounded-xl ${
            entry.status === "waiting" ? "bg-amber-100" :
            entry.status === "contacted" ? "bg-blue-100" :
            entry.status === "converted" ? "bg-green-100" : "bg-gray-100"
          }`}>
            <Users className={`h-8 w-8 ${
              entry.status === "waiting" ? "text-amber-600" :
              entry.status === "contacted" ? "text-blue-600" :
              entry.status === "converted" ? "text-green-600" : "text-gray-600"
            }`} />
          </div>
        }
        actions={
