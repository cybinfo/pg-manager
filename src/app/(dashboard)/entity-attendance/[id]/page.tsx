...
export default function LibraryAttendanceDetailPage() {
  ...
  const { backHref, backLabel } = useBackNavigation({ defaultHref: "/entity-attendance", defaultLabel: "All Attendance" })
  ...
  if (!attendance) {
    return <NotFoundState title="Attendance record not found" backHref="/entity-attendance" backLabel="All Attendance" />
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <DetailHero
        ...
        backLabel={backLabel}
        breadcrumbs={[
          { label: "Library Attendance", href: "/entity-attendance" },
          { label: displayName },
        ]}
        ...
        actions={
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {attendance.member && (
              <Link href={`/entity-members/${attendance.member.id}`}>
            ...
            <PermissionGate permission="entity_attendance.edit" hide>
              <Link href={`/entity-attendance/${params.id}/edit`}>
                <Button variant="outline" size="sm">
        ...
        {attendance.member && (
          ...
          >
            <div className="flex items-center gap-4 p-4 bg-muted/50 rounded-lg">
              ...
              <div>
                <Link
                  href={`/entity-members/${attendance.member.id}`}
