...
export default function EditAttendancePage({
  ...
  return (
    <PermissionGuard permission="entity_attendance.edit">
...
function EditAttendanceContent({
  ...
  const {
    ...
    redirectTo: `/entity-attendance/${id}`,
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <DetailHero
        ...
        icon={Clock}
        breadcrumbs={[{ label: "Attendance", href: "/entity-attendance" }, { label: "Edit Attendance" }]}
      />
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end gap-3">
          <Link href={`/entity-attendance/${id}`}>
