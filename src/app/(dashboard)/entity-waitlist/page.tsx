...
export default function LibraryWaitlistPage() {
  ...
  return (
    <ListPageTemplate
      ...
      icon={Users}
      permission="entity_waitlist.view"
      module="waitlist"
...
exportColumns={exportColumns}
      ...
      onRowClick={(item) => router.push(`/entity-waitlist/${item.id}`)}
      createHref="/entity-waitlist/new"
      createLabel="Add to Waitlist"
      createPermission="entity_waitlist.create"
