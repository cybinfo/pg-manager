...
export default function AddToWaitlistPage() {
  return (
    <PermissionGuard permission="entity_waitlist.create">
...
function AddToWaitlistContent() {
  ...
  const {
    ...
    customSubmit: async (data, userId, supabase) => {
      ...
      const { error } = await supabase.from("entity_waitlist").insert(waitlistData)
