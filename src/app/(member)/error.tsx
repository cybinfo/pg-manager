 ...
 * Catches errors within the library member self-service portal and displays
 * a recovery page with navigation back to the member home.
 */
...
export default function MemberPortalError({ error, reset }: ErrorPageProps) {
  useEffect(() => {
    console.error("[MemberPortalError]", {
